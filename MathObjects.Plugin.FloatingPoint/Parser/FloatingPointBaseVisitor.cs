...
public partial class FloatingPointBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IFloatingPointVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="FloatingPointParser.FuncCall"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="FloatingPointParser.Negative"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="FloatingPointParser.Exponent"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
