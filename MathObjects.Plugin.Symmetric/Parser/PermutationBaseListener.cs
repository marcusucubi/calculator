...
/// <summary>
/// This class provides an empty implementation of <see cref="IPermutationListener"/>,
/// which can be extended to create a listener which only needs to handle a subset
/// of the available methods.
/// </summary>
[System.CodeDom.Compiler.GeneratedCode("ANTLR", "4.5.1")]
[System.CLSCompliant(false)]
public partial class PermutationBaseListener : IPermutationListener {
	/// <summary>
	/// Enter a parse tree produced by <see cref="PermutationParser.init"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterInit([NotNull] PermutationParser.InitContext context) { }
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void EnterValue([NotNull] PermutationParser.ValueContext context) { }
	/// <summary>
	/// Exit a parse tree produced by <see cref="PermutationParser.value"/>.
	/// <para>The default implementation does nothing.</para>
	/// </summary>
	/// <param name="context">The parse tree.</param>
	public virtual void ExitValue([NotNull] PermutationParser.ValueContext context) { }
