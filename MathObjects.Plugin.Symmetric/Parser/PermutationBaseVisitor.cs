...
public partial class PermutationBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IPermutationVisitor<Result> {
	...
	public virtual Result VisitFile([NotNull] PermutationParser.FileContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitExponent([NotNull] PermutationParser.ExponentContext context) { return VisitChildren(context); }
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitParens([NotNull] PermutationParser.ParensContext context) { return VisitChildren(context); }
	/// <summary>
